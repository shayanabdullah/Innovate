...
const Work = () => {
 ...
 <section className='lg:py-32 md:pt-24 sm:py-24 py-20  bg-white' id='blog'>
    ...
    <div className=" flex justify-between items-center w-full pr-3 pb-10">
    <div className="pl-3">
                  <h5 className='font-nurito font-semibold lg:text-2xl text-lg md:text-xl sm:text-xl text-[#7968EF] pb-2.5'>
                  Our works
                  </h5>
              
                    <h1 className='font-popins font-semibold lg:text-5xl capitalize text-[#29313D] lg:leading-[150%] text-3xl md:text-4xl sm:text-3xl leading-[130%] lg:pb-16 pb-12 md:pb-16 sm:pb-14'>Our case</h1>
                  </div>
            ...
            <div className="card-section grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2  gap-8">
              <div className="card-1 w-full  overflow-hidden lg:p-0 md:p-0 sm:p-0 pl-3">
        ...
        <div className="">
        <div className="card-3 overflow-hidden lg:p-0 md:p-0 sm:p-0 pl-3  ">
                  <div className="img-box rounded-3xl bg-[#C4C4C4] ">
                    <Images src={card2}/>
                  </div>
